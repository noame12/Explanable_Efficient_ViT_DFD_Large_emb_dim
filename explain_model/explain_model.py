...
model_weights = os.path.join(MODELS_PATH,'efficientnetB0_checkpoint25_All_emb_size_392') #TODO: update with the latest model
...
with open('test_summary_All_examples_few.csv') as csv_file: #TODO: verify the right file name
